...
#set the directory
setwd("D:\\ENGINEERING\\SEMESTER-8\\Project Work\\Experiment\\SVM_RFE implementation\\4 class\\All Features")

#import ranklist
ranklist<-read_excel("RankList using SVM_RFE-4 classes(All Features).xlsx", 
...
while(length(ranklist))
{
      ...
      for (C in costValues) 
      {
            ...
            print(conMatrix)
            MCC1<-computeMCC(conMatrix)
            
            write("\nMCC1:", file = "MCC vs Feature subset 4-class Execution.txt",append=TRUE)
            write(as.numeric(MCC1), file = "MCC vs Feature subset 4-class Execution.txt",append=TRUE)
            ...
            conMatrix<-confusionMatrix(pred_validation,validation_label)
            print(conMatrix)
            MCC2<-computeMCC(conMatrix)
            
            write("\nMCC2:", file = "MCC vs Feature subset 4-class Execution.txt",append=TRUE)
            write(as.numeric(MCC2), file = "MCC vs Feature subset 4-class Execution.txt",append=TRUE)
            ########################################################################################################
            ...
            if(MCCavg > best_MCC)
            {
                  ...
                  write("\nnow best cost is:", file = "MCC vs Feature subset 4-class Execution.txt",append=TRUE)
                  write(as.numeric(best_cost), file = "MCC vs Feature subset 4-class Execution.txt",append=TRUE)
                  
                  write("\nnow best MCC is:", file = "MCC vs Feature subset 4-class Execution.txt",append=TRUE)
                  write(as.numeric(best_MCC), file = "MCC vs Feature subset 4-class Execution.txt",append=TRUE)
      ...
      print(best_cost)
      write("\nFinal best_cost:", file = "MCC vs Feature subset 4-class Execution.txt",append=TRUE)
      write(as.numeric(best_cost), file = "MCC vs Feature subset 4-class Execution.txt",append=TRUE)
      ...
      write("\nbest_Gamma_for_LE:", file = "MCC vs Feature subset 4-class Execution.txt",append=TRUE)
      write(as.numeric(best_Gamma_for_LE), file = "MCC vs Feature subset 4-class Execution.txt",append=TRUE)
      ...
      write("\nFinal Confusion Matrix:", file = "MCC vs Feature subset 4-class Execution.txt",append=TRUE)
      write(as.table(final_conMatrix), file = "MCC vs Feature subset 4-class Execution.txt",append=TRUE)
      ...
      write("\n========================================================================",
            file = "MCC vs Feature subset 4-class Execution.txt",append=TRUE)
}
...
write(MatthewsCC, file = "SVM Feature subset MCCs for 4 classes.txt")
...
pl<-ggplot(mapping = aes(y=MatthewsCC, x=Feature_subset_size))+ggtitle("SVM MCC vs Feature subset plot for 4 classes(All Features)")+
      geom_line()+
