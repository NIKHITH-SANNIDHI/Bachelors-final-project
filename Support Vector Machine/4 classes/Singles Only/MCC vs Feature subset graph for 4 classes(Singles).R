...
while(length(ranklist))
{
      ...
      for (C in costValues) 
      {
            ...
            write("\nMCC1:", file = "MCC vs Feature subset 4-class Execution(Singles).txt",append=TRUE)
            write(as.numeric(MCC1), file = "MCC vs Feature subset 4-class Execution(Singles).txt",append=TRUE)
            ...
            write("\nMCC2:", file = "MCC vs Feature subset 4-class Execution(Singles).txt",append=TRUE)
            write(as.numeric(MCC2), file = "MCC vs Feature subset 4-class Execution(Singles).txt",append=TRUE)
            ########################################################################################################
            ...
            if(MCCavg > best_MCC)
            {
                  ...
                  write("\nnow best cost is:", file = "MCC vs Feature subset 4-class Execution(Singles).txt",append=TRUE)
                  write(as.numeric(best_cost), file = "MCC vs Feature subset 4-class Execution(Singles).txt",append=TRUE)
                  
                  write("\nnow best MCC is:", file = "MCC vs Feature subset 4-class Execution(Singles).txt",append=TRUE)
                  write(as.numeric(best_MCC), file = "MCC vs Feature subset 4-class Execution(Singles).txt",append=TRUE)
      ...
      print(best_cost)
      write("\nFinal best_cost:", file = "MCC vs Feature subset 4-class Execution(Singles).txt",append=TRUE)
      write(as.numeric(best_cost), file = "MCC vs Feature subset 4-class Execution(Singles).txt",append=TRUE)
      ...
      write("\nbest_Gamma_for_LE:", file = "MCC vs Feature subset 4-class Execution(Singles).txt",append=TRUE)
      write(as.numeric(best_Gamma_for_LE), file = "MCC vs Feature subset 4-class Execution(Singles).txt",append=TRUE)
      ...
      write("\nFinal Confusion Matrix:", file = "MCC vs Feature subset 4-class Execution(Singles).txt",append=TRUE)
      write(as.table(final_conMatrix), file = "MCC vs Feature subset 4-class Execution(Singles).txt",append=TRUE)
      ...
      write("\n========================================================================",
            file = "MCC vs Feature subset 4-class Execution(Singles).txt",append=TRUE)
}
...
write(MatthewsCC, file = "SVM Feature subset MCCs for 4 classes(Singles).txt")
...
pl<-ggplot(mapping = aes(y=MatthewsCC, x=Feature_subset_size))+ggtitle("SVM MCC vs Feature subset plot for 4 classes(Singles)")+
      geom_line()+
