...
final_list <-SVM_RFE(BIG.A[1:45], BIG.A$CLASS)
...
write_xlsx(Feature_names, path = "D:\\ENGINEERING\\SEMESTER-8\\Project Work\\Experiment\\SVM_RFE implementation\\2 class\\All Features\\RankList using SVM_RFE-2 classes(All Features).xlsx",
           col_names = FALSE)
