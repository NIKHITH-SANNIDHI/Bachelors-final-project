...
#The rank list considered is 2-Class Singles+Ratios
################################################################################
...
#set the directory
setwd("D:\\ENGINEERING\\SEMESTER-8\\Project Work\\Experiment\\SVM_RFE implementation\\2 class\\All Features")

#import ranklist
ranklist<-read_excel("RankList using SVM_RFE-2 classes(All Features).xlsx", 
...
#import test data
testing<-read.csv("MBD_CLASS(All Features)_test.csv")
...
while(length(ranklist))
{
      ...
      for (C in costValues) 
      {
            ...
            write("\nMCC1:", file = "MCC vs Feature subset 2-class Execution.txt",append=TRUE)
            write(as.numeric(MCC1), file = "MCC vs Feature subset 2-class Execution.txt",append=TRUE)
            ...
            write("\nMCC2:", file = "MCC vs Feature subset 2-class Execution.txt",append=TRUE)
            write(as.numeric(MCC2), file = "MCC vs Feature subset 2-class Execution.txt",append=TRUE)
            ########################################################################################################
            ...
            if(MCCavg > best_MCC)
            {
                  ...
                  write("\nnow best cost is:", file = "MCC vs Feature subset 2-class Execution.txt",append=TRUE)
                  write(as.numeric(best_cost), file = "MCC vs Feature subset 2-class Execution.txt",append=TRUE)
                  
                  write("\nnow best MCC is:", file = "MCC vs Feature subset 2-class Execution.txt",append=TRUE)
                  write(as.numeric(best_MCC), file = "MCC vs Feature subset 2-class Execution.txt",append=TRUE)
      ...
      print(best_cost)
      write("\nFinal best_cost:", file = "MCC vs Feature subset 2-class Execution.txt",append=TRUE)
      write(as.numeric(best_cost), file = "MCC vs Feature subset 2-class Execution.txt",append=TRUE)
      ...
      write("\nbest_Gamma_for_LE:", file = "MCC vs Feature subset 2-class Execution.txt",append=TRUE)
      write(as.numeric(best_Gamma_for_LE), file = "MCC vs Feature subset 2-class Execution.txt",append=TRUE)
      ...
      write("\nFinal Confusion Matrix:", file = "MCC vs Feature subset 2-class Execution.txt",append=TRUE)
      write(as.table(final_conMatrix), file = "MCC vs Feature subset 2-class Execution.txt",append=TRUE)
      ...
      write("\n========================================================================",
            file = "MCC vs Feature subset 2-class Execution.txt",append=TRUE)
}
...
write(MatthewsCC, file = "SVM Feature subset MCCs for 2 classes.txt")
print("MCC List written to File!")

#Plot the Graph

Feature_subset_size<-c(45:2)
Feature_subset_size

pl<-ggplot(mapping = aes(y=MatthewsCC, x=Feature_subset_size))+ggtitle("SVM MCC vs Feature subset plot for 2 classes(All Features)")+
      geom_line()+
