...
#This program implements multiclass RF-RFE
...
final_list <-RF_RFE(BIG.A[1:30], BIG.A$TARGETtype)
...
write_xlsx(Feature_names, path = "D:\\ENGINEERING\\SEMESTER-8\\Project Work\\Experiment\\Random Forests\\4 class\\Singles\\RankList using RF_RFE-4 classes(Singles).xlsx",
           col_names = FALSE)
