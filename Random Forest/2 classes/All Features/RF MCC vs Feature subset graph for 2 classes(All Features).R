...
#import ranklist
ranklist<-read_excel("RankList using RF_RFE-2 classes(All Features).xlsx", 
...
while(length(ranklist))
{
      ...
      write("\nerrorValues", file = "RF MCC vs Feature subset 2-class Execution.txt",append=TRUE)
      write(as.table(errorValues), file = "RF MCC vs Feature subset 2-class Execution.txt",append=TRUE)
      ...
      write("\nOptimumTrees:", file = "RF MCC vs Feature subset 2-class Execution.txt",append=TRUE)
      write(as.table(OptimumTrees), file = "RF MCC vs Feature subset 2-class Execution.txt",append=TRUE)
      ...
      write("\nFinal Confusion Matrix:", file = "RF MCC vs Feature subset 2-class Execution.txt",append=TRUE)
      write(as.table(final_conMatrix), file = "RF MCC vs Feature subset 2-class Execution.txt",append=TRUE)
      ...
      write("\n========================================================================",
            file = "RF MCC vs Feature subset 2-class Execution.txt",append=TRUE)
...
write(MatthewsCC, file = "RF Feature subset MCCs for 2 classes.txt")
print("MCC List written to File!")

#Plot the Graph

Feature_subset_size<-c(45:1)
Feature_subset_size

pl<-ggplot(mapping = aes(y=MatthewsCC, x=Feature_subset_size))+ggtitle("RF MCC vs Feature subset plot for 2 classes(All Features)")+
      geom_line()+
