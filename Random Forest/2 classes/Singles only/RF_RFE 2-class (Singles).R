...
final_list <-RF_RFE(BIG.A[1:30], BIG.A$CLASS)
...
write_xlsx(Feature_names, path = "D:\\ENGINEERING\\SEMESTER-8\\Project Work\\Experiment\\Random Forests\\2 class\\Singles\\RankList using RF_RFE-2 classes(Singles).xlsx",
           col_names = FALSE)
